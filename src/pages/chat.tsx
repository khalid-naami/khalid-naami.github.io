            ...
            case 'linux':
                return (
                    <div>
                        ...
                        <pre style={{ background: isDark ? '#111' : '#EEE', padding: '0.5rem', borderRadius: '4px', marginTop: '0.5rem', fontSize: '0.85em' }}>[Service]<br/>Environment="OLLAMA_ORIGINS=https://khalidnaami.com"</pre>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'stretch', gap: '1rem', marginTop: '1rem' }}>
                <div style={{...panelStyle, justifyContent: 'flex-start', flex: 1}}>
                    ...
                    <p style={{ marginTop: '1rem', marginBottom: '1rem' }}>
                        ...
                        This tells Ollama to accept requests from <strong>https://khalidnaami.com</strong>.
                    </p>
