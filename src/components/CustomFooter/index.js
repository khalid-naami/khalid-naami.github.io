          ...
          <div className="row flex justify-center items-center">
            <div className="col text-center">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <a href="https://www.linkedin.com/in/khalid-naami-a953263bb/" target="_blank" rel="noreferrer" className="text-black dark:text-white hover:text-ds-blue-primary dark:hover:text-ds-blue-accent" title="Personal LinkedIn" aria-label="Follow Khalid Naami on LinkedIn">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://x.com/DashboardOption" target="_blank" rel="noreferrer" className="text-black dark:text-white hover:text-ds-blue-primary dark:hover:text-ds-blue-accent" title="Dashboard Options X" aria-label="Follow Dashboard Options on X">
                ...
                <a href="https://www.linkedin.com/company/dashboard-options/" target="_blank" rel="noreferrer" className="text-black dark:text-white hover:text-ds-blue-primary dark:hover:text-ds-blue-accent" title="Dashboard Options LinkedIn" aria-label="Follow Dashboard Options on LinkedIn">
                  <div className="flex flex-col items-center leading-none">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                    </svg>
                ...
                <a href="https://github.com/khalid-naami" target="_blank" rel="noreferrer" className="text-[#333] dark:text-[#f5f5f5] hover:text-ds-blue-primary dark:hover:text-ds-blue-accent" aria-label="GitHub">
                ...
                <a href="https://www.youtube.com/@DashboardOptions" target="_blank" rel="noreferrer" className="text-[#FF0000] dark:text-[#ff4d4d] hover:text-ds-blue-primary dark:hover:text-ds-blue-accent" aria-label="YouTube">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
