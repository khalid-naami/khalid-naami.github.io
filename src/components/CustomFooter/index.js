          ...
          <div className="row flex justify-center items-center">
            <div className="col text-center">
              ...
              <div className="flex justify-center space-x-4">
                {/* Personal Socials */}
                <a href="https://x.com/khalidnaami0" target="_blank" rel="noreferrer" style={{ color: '#1da1f2' }} className="hover:opacity-85 hover:scale-110 transition-transform duration-300" title="Personal X" aria-label="Follow Khalid Naami on X">
                ...
                <a href="https://x.com/DashboardOption" target="_blank" rel="noreferrer" style={{ color: '#1da1f2' }} className="hover:opacity-85 hover:scale-110 transition-transform duration-300" title="Dashboard Options X" aria-label="Follow Dashboard Options on X">
                ...
                <a href="https://github.com/khalid-naami" target="_blank" rel="noreferrer" style={{ color: '#6e7681' }} className="hover:text-black dark:hover:text-white hover:scale-110 transition-transform duration-300" aria-label="GitHub">
                ...
                <a href="https://cal.com/khnaami" target="_blank" rel="noreferrer" style={{ color: '#4f46e5' }} className="hover:opacity-85 hover:scale-110 transition-transform duration-300" aria-label="Book a meeting">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
