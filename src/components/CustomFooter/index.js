          ...
          <div className="row flex justify-center items-center">
            <div className="col text-center">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <a href="https://github.com/khalidnaami3-wq" target="_blank" rel="noreferrer" className="text-[#333] dark:text-[#f5f5f5] hover:text-ds-blue-primary dark:hover:text-ds-blue-accent">
