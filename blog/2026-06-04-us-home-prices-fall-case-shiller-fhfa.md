...
keywords: [U.S. Home Prices, Housing Market Slowdown, Case-Shiller Index, FHFA Index, Real Estate Bubble, Texas Housing Market, Florida Housing Market, Energy Shock, Affordability Crisis, Global Economy, Khalid Naami]
image: /img/us-housing-market-slowdown.webp
slug: us-home-prices-decline-case-shiller-fhfa
date: 2026-06-04T14:00:00Z
schema_type: [NewsArticle, TechArticle]
---

# Home Prices Fall: Case-Shiller and FHFA Signal Housing Slump
...
![U.S. Housing Market Slowdown](/img/us-housing-market-slowdown.webp)
...
Let's start with Case-Shiller. The [S&P CoreLogic Case-Shiller Index](https://www.spglobal.com/spdji/en/indices/indicators/sp-corelogic-case-shiller-us-national-home-price-nsa-index/#overview) is one of the most widely followed home price measures in the country because it looks at repeat sales. In other words, it's not just comparing whatever mix of homes happen to sell this month versus last month. It's trying to track price changes for the same homes over time. And that makes it useful for spotting turning points. 
...
![U.S. Case-Shiller and FHFA Home Price Trends](/img/us-housing-market-chart.webp)
...
> What if your gold could actually pay you every single month in more gold? That's what today's sponsor, [Monetary Metals](https://monetary-metals.com/snyder), lets you do. 
> 
...
> 
> If you're a long-term gold holder looking for a smarter way to store value, check them out at [monetary-metals.com/snyder](https://monetary-metals.com/snyder) to see if they're the right fit for you.
...
Now, existing homeowners who waited for the spring rebound this year are finding out that the buyer pool is not what it used to be. That's how you get two monthly declines in a row for Case-Shiller. This transition is highly reminiscent of the trend we explored in our analysis of [home sales plunging to 2010 levels](/blog/home-sales-plunging-2010-levels), where a hidden labor market contraction began to freeze buyer demand.
...
Housing is a slow-moving market. It usually doesn't fall apart all at once. First, you see sales that freeze up and inventory begins to build. Then sellers resist reality, but eventually they have to cut prices, and then indexes begin to slow. Next, the weakest local markets go negative, and eventually the national numbers follow. We are well into that sequence now, showing a trend where [new home sales collapse under energy shocks](/blog/new-home-sales-collapse-energy-shock) before index prices even reflect the full extent of the macroeconomic damage.

---

## FHFA index Signals the Worst Since 2012

The [FHFA House Price Index](https://www.fhfa.gov/DataTools/Downloads/Pages/House-Price-Index.aspx) is telling us the same exact story from a slightly, if not materially, different angle. It's constructed differently than Case-Shiller, which is a positive here. FHFA is based on mortgages backed by Fannie and Freddie, so it doesn't capture the entire housing market in the same way. It excludes some jumbo loans and cash transactions, giving it a different geographic and price tier mix.
