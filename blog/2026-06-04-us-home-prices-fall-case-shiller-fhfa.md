...
The [FHFA House Price Index](https://www.fhfa.gov/data/hpi) is telling us the same exact story from a slightly, if not materially, different angle. It's constructed differently than Case-Shiller, which is a positive here. FHFA is based on mortgages backed by Fannie and Freddie, so it doesn't capture the entire housing market in the same way. It excludes some jumbo loans and cash transactions, giving it a different geographic and price tier mix.
